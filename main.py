...
if __name__ == "__main__":
    ...
    for row in tweets:
        ...
        if num == 100:
            break
        # input4 = "Find relevant information about each of the food a human to learn what food to cook with it and how to recycle it the result itself it must be very short and brief overall under 25 words for each FOOD make sure it is in PYTHON list DO NOT INCLUDE (slash)n at all remove all other unnecessary words"
    ...
    print("ChatBot Results: ", food_result)
